...
namespace GestaoObrasLib
{
    public class Fornecedor
    {
        ...
        #region Construtores
        /// <summary>
        /// Construtor que inicializa um novo Fornecedor com nome, tipo e contato.
        /// </summary>
        public Fornecedor(string nome, string descricao, string contacto)
        {
            this.nome = nome;
        ...
        public void MostrarInfo()
        {
            ...
            Console.WriteLine($"Contato: {this.contacto}");
        }
        #endregion
